...
#include "vtkSRPlanVolumeRenderingModuleMRMLExport.h"

// MRML includes
#include "vtkMRMLNode.h"

/// \ingroup Slicer_QtModules_VolumeRendering
class VTK_SRPlan_VOLUMERENDERING_MODULE_MRML_EXPORT vtkMRMLVolumeRenderingScenarioNode : public vtkMRMLNode
{
  public:
