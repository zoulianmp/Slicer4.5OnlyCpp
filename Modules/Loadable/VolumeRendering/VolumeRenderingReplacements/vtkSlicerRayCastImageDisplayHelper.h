...
class Q_SRPlan_QTMODULES_VOLUMERENDERING_REPLACEMENTS_EXPORT vtkSlicerRayCastImageDisplayHelper : public vtkObject
{
public:
  static vtkSlicerRayCastImageDisplayHelper *New();
  vtkTypeMacro(vtkSlicerRayCastImageDisplayHelper,vtkObject);
