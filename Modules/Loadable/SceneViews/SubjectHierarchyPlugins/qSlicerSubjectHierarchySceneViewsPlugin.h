...
#include "qSRPlanSceneViewsSubjectHierarchyPluginsExport.h"
...
class Q_SRPlan_SCENEVIEWS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qSlicerSubjectHierarchySceneViewsPlugin : public qSlicerSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
